package com.example.railRoadOperations.tests
...
@MicronautTest
class TrainControlerTest {

    @Inject
    @field:Client("/")
    lateinit var client : HttpClient

    val trains: ArrayList<Train> = arrayListOf(
    ...
    val classificationTracks: ArrayList<ClassificationTrack> = arrayListOf(
